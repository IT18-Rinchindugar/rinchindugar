...
export const metadata: Metadata = {
  title: "Project | Rinchindugar Ochirsum",
  metadataBase: new URL("https://rinchindugar.com/projects"),
  description: "Explore projects built by Rinchindugar Ochirsum",
  openGraph: {
    title: "Projects | Rinchindugar Ochirsum",
    url: "https://rinchindugar.com/projects",
    description: "Explore projects built by Rinchindugar Ochirsum",
    images:
